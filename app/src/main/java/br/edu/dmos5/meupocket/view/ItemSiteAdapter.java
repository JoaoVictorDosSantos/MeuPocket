...
public class ItemSiteAdapter extends ArrayAdapter {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        listener para esse objeto. Aqui vamos implementar um onClick() que executa a trocada imagem do favorito.*/
        holder.favoritoImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (view == holder.favoritoImageView) {
                    //metodo responsavel por atualizar o status de favorito e de notificar o Adapter
                    //que um objeto foi atualizado
        ...
        método construtor.Aqui vamos recuperar o o objeto (Site) que está na fonte de dados
        utilizando o métodogetItem() do ArrayAdapter. Com o objeto recuperado vamos inserir os
        dados dele nos elementos de layout que possuímos e estão com a referência dentro do holder.
        Atenção para a imagem, que recuperamos uma imagem de acordo com a preferência do usuário
     ...
     *Ela consegue "enchergar" tudo da classe ItemSiteAdapter.
     *Vamos utilizar essa classe para armazenar as referências dos elementos de layout
     *que estão no layout item_lista_pocket.
     */
